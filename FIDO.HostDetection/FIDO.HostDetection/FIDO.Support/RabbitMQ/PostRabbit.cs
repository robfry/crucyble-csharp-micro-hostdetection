...
namespace FIDO.HostDetection.FIDO.Support.RabbitMQ
{
  public class PostRabbit
  {
    ...
    public void Post(string sExchange, string sRoutingKey, string sQueue, string hostname, string msgBody, Object_Event_Queue.PrimaryConfig eventQue)
    {
    ...
    public void Post(string sExchange, string hostname, string msgBody, Object_Event_Queue.PrimaryConfig eventQue)
    {
      var factory = new ConnectionFactory() { HostName = hostname };
      try
      {
